...
/* isr_rcx */
#define isr_rcx__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define isr_rcx__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define isr_rcx__INTC_MASK 0x01u
#define isr_rcx__INTC_NUMBER 0u
#define isr_rcx__INTC_PRIOR_NUM 7u
#define isr_rcx__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define isr_rcx__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define isr_rcx__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
